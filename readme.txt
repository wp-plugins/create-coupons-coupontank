...
3. Open your plugin files and edit create-coupons-coupontank/ct-coupons.php and change the
...
Themes are kept in the create-coupons-coupontank/themes directory, and the name of the theme
...
4. Upload the plugin `create-coupons-coupontank/` to the `/wp-content/plugins/` directory
...
settings for your plugin. Now, edit create-coupons-coupontank/ct-coupons.php and change the
