...
== Installation ==
1. Download the CouponTank plugin from :
http://wordpress.org/extend/plugins/create-coupons-coupontank/

Login to your wordpress account as an administrator
Open the 'Plugins' panel, and click 'Add New'
...
6. Change the subdomain from 'sample' to your coupontank subdomain, that you
signed up with at www.coupontank.com
--// snippet
$coupontank = array(
  'subdomain' => 'sample'
);
...
7. Click 'Update File'.  Your coupontank app coupons for wordpress will now
display in the coupontank tab.
